          ...
          <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:col-span-2 dark:border-slate-700 dark:bg-slate-900">
            <div className="relative h-64 sm:h-80">
              <Image
                ...
                alt="Renaissance painting being examined"
                fill
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              ...
              <p className="mt-2 text-sm text-white/80 line-clamp-2">
                How expert authentication and provenance research turned a
                forgotten piece into the highlight of our spring auction.
              </p>
              <div className="mt-4 flex items-center justify-between">
                <span className="text-xs text-white/60">5 min read</span>
                <Link
                  href="/stories/renaissance-panel"
          ...
          <div className="space-y-6">
            <article className="group">
              ...
              <div className="mt-3">
                ...
                <Link
                  href="/stories/collector-journey"
            ...
            <article className="group">
              <div className="relative h-32 overflow-hidden rounded-xl">
                <Image
                  ...
                  alt="Vintage watch authentication process"
                  fill
                  className="object-cover transition duration-300 group-hover:scale-105"
                />
              </div>
              <div className="mt-3">
                ...
                <Link
                  href="/stories/authentication-process"
                  className="mt-2 text-xs text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200"
                >
                  4 min read →
                </Link>
